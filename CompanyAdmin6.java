...
public static void main(String[] args) {
	    ...
	    //Request a new agent in Dashboard
	      ...
	      d.get("https://license.ntheye.com/request/list_request");
	     ...
	     d.get("https://license.ntheye.com/request/list_request");
	     d.get("https://license.ntheye.com/request/list_request?type=0");
	     d.findElement(By.xpath("//a[contains(text(),'Cancel')]")).click();
	    d.get("https://license.ntheye.com/request/list_request?type=2");
	    d.get("https://license.ntheye.com/support/logout");
	    d.get("https://license.ntheye.com/activity/list_activity");
	    d.close();
}
}
