...
public static void main(String[] args) {
	...
	d.get("https://license.ntheye.com/admin/login");
     ...
     Select sl = new Select(n);
      ...
      d.get("https://license.ntheye.com/admin/request/list_admin_request_new");
      d.get("https://license.ntheye.com/admin/software/list_software_request");
      d.get("https://license.ntheye.com/admin/dashboard/logout");
}
}
